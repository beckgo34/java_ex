...
public class Database {
     ...
     *              U(Update):데이터 수정
     *              D(Delete):데이터 삭제
     *      d. SQL(Stuctured Query language)
     *          1.DBMS를 사용하는 문법
     *          2.구조화된 질의어
     ...
     *              );
     *      6.ERD(Entity Relationship Diagram, 개체 관계 모델)
     *          a. 테이블간의 관계를 그림으로 표현한 것
     *          b. 설계단계에서 작성하며, 누구나 ERD를 보고 테이블 생성 쿼리를 작성할 수 있음.
     *
     *
     *      7. 연습
     *          a. 계정이름:user_user_2
     ...
     *              1. 식별관계
     *                      1. 실선으로 표현
     *                      2. 부모테이블의 pk컬럼을 자식도 pk컬럼으로 사용하는 관계
     *              2. 비식별관계
     *                      1. 대시선으로 표현
     *                      2. 부모테이블의 pk칼럼을 자식테이블에서 별도의 참조 컬럼으로 사용하는 관계
     *
     *
     */
}
